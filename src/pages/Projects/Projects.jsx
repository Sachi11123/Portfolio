...
const projects = [
  ...
  },
  {
    title: "Home Theatre 🔥",
    description:
      "Home Theatre is a collaborative movie-watching platform where users can upload movies and watch them together in real-time. The platform also includes a live chat feature, allowing viewers to interact while watching. built with Javasript and websocket 💻✨",
    src: "house.jpg",
    link: "https://i.postimg.cc/NMH2bFFX/Home-theatre.png",
    color: "#ed649e",
